...
@WebAppConfiguration
public class ResourceDomainTopnDetailControllerTest {
    ...
    public void findRate() throws Exception {
        String responseString = mockMvc.perform(MockMvcRequestBuilders.get("/service/resource/resourceDomainTopnDetail/findRate/v1") //请求的url,请求的方法是get
