 ...
 */
@Data
public class PartnerDomainCnameFlow extends BaseRptEntity {
    /**
     * table 前缀
     */
    private static final String TABLE_PREFIX = "rpt_resource_specific_domain_name_cname_";

    /**
     * cname表名.
     */
    private static final String CNAME_TABLE_PREFIX = "rpt_resource_specific_domain_name_cname_detail_";
    ...
    @JsonIgnore
    public static final String CSV_NAME = "域名CNAME流量分析报表";
    @JsonIgnore
    public static final String CSV_HEAD = "时间段,域名,别名,下发状态,出网流量(G),出网次数,解析次数,成功次数\n";
