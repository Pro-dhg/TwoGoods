...
@Data
@ApiModel
public class ResourceWebsiteUserSourceVO {
    ...
    @JsonIgnore
    private static final String TABLE_PREFIX = "rpt_resource_website_topn_user_distribution_";
    ...
    @ApiModelProperty(value = "网内无数据")
    private String netInZero;

    @ApiModelProperty(value = "省内无数据")
