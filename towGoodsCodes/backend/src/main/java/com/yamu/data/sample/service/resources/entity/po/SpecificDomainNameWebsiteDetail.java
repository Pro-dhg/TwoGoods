 ...
 */
@Data
public class SpecificDomainNameWebsiteDetail extends BaseRptEntity {
    ...
    @JsonIgnore
    public static final String CSV_NAME = "特定域名TopN分类分析报表";
    @JsonIgnore
    public static final String CSV_HEAD = "时间,网站类型,解析次数,IPv4解析次数,成功次数,成功率,网内次数(IPv4),本网率,出网次数(IPv4),出网率,本省次数,本省率,外省次数,出省率,CDN次数,IDC次数\n";
    @JsonIgnore
    ...
    @JsonIgnore
    private String queryTable = TABLE_PREFIX + "1h";

    //table 前缀
    private static final String TABLE_PREFIX = "rpt_resource_specific_domain_name_website_detail_";
