...
@Data
public class ResourceWebsiteTopNCdnBusinessDetail extends BaseRptEntity {
    ...
    //table 前缀
    private static final String TABLE_PREFIX = "rpt_resource_website_cdn_business_";
     ...
     * @param queryType
     */
//    public void setQueryTable(String queryType) {
//
